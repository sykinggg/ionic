...
var settings = {
	...
	url_dl: "https://fi.openspeed.org/garbage.php", // path to a large file or garbage.php, used for download test. must be relative to this js file
	url_ul: "https://fi.openspeed.org/empty.php", // path to an empty file, used for upload test. must be relative to this js file
	url_ping: "https://fi.openspeed.org/empty.php", // path to an empty file, used for ping test. must be relative to this js file
